...
public class JobTest {
    ...
    public void testToStringHandlesEmptyField() {
        ...
        assertEquals(test_job3.toString(),s+ "ID: " + test_job3.getId() +s + "Name: " + test_job3.getName() +s +"Employer: " + test_job3.getEmployer() +s+"Location: " + test_job3.getLocation() +s +"Position Type: " + test_job3.getPositionType() +s +"Core Competency: " + test_job3.getCoreCompetency() +s);
    }
